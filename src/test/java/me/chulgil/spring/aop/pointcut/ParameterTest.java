...
public class ParameterTest {
    ...
    static class ParameterAspect {
        ...
        @Pointcut("execution(* me.chulgil.spring.aop.member..*.*(..))")
        ...
        public void thisArgs(JoinPoint joinPoint, IMemberService obj) {
            log.info("[this]{}, obj={}", joinPoint.getSignature(), obj.getClass());
        }

        @Before("allMember() && target(obj)")
        public void targetArgs(JoinPoint joinPoint, IMemberService obj) {
